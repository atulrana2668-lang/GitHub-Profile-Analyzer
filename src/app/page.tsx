...
const POPULAR = ["torvalds", "sindresorhus", "gaearon", "yyx990803", "tj"];
  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-mesh">
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-20 sm:py-28">
        ...
        {/* Headline */}
        <h1 className="text-center text-4xl font-black leading-tight tracking-tight text-white sm:text-6xl md:text-7xl">
          Know your{" "}
        ...
        <p className="mx-auto mt-5 max-w-xl text-center text-base text-slate-400 sm:text-lg">
          Deep-dive into any GitHub profile. Instant insights on activity,
          language mastery, repositories, and your global ranking.
        </p>
